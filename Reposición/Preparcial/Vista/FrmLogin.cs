...
namespace Preparcial
{
    public partial class FrmLogin : Form
    {
        ...
        private void BttnUpdatePassword_Click(object sender, EventArgs e)
        {
            ...
            frmPassword.ShowDialog();//Corrección(?) estética: Se cambió ".Show()" por ".ShowDialog()"
            PoblarControlers();//Corrección(?): Agregado para actualizar la contraseña en el Login 
        }
    }
}
